...
// y Ogre::Singleton.
class TrackManager: public Ogre::ResourceManager, public Ogre::Singleton<
		TrackManager> {
public:
	TrackManager();
	virtual ~TrackManager();
	virtual TrackPtr load(const Ogre::String& name, const Ogre::String& group =
